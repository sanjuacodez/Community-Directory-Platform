...
export default function FamiliesPage() {
  ...
  return (
    <div className="space-y-6"><div className="flex items-center justify-between"><h1 className="text-2xl font-bold">Families</h1><div className="flex gap-2">{roles.includes('super_admin')&&<><Link href="/communities/create" className="rounded-lg border border-zinc-300 px-3 py-2 text-sm hover:bg-zinc-50">+ Community</Link><Link href="/families/create" className="rounded-lg bg-zinc-900 px-4 py-2 text-sm text-white hover:bg-zinc-800">Add Family</Link></>}</div></div>
